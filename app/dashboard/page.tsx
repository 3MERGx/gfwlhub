        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className={`grid grid-cols-1 sm:grid-cols-2 ${isAdmin ? "lg:grid-cols-4" : "lg:grid-cols-3"} gap-4 sm:gap-5 md:gap-6 mb-6 sm:mb-8 md:mb-10`}>
            ...
            <div className="bg-gradient-to-br from-green-500/10 to-green-600/5 p-5 sm:p-6 rounded-xl border border-green-500/20 shadow-lg">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-gray-300 text-sm font-medium">Approved</h3>
          ...
          <div className={`grid grid-cols-1 md:grid-cols-2 ${isAdmin ? "lg:grid-cols-3" : "lg:grid-cols-2"} gap-3 sm:gap-4 md:gap-6 mb-4 sm:mb-6 md:mb-8`}>
            ...
            <Link
              ...
              className="bg-gradient-to-br from-[#2d2d2d] to-[#252525] p-5 sm:p-6 md:p-7 rounded-xl border border-gray-700 hover:border-[#107c10] hover:shadow-lg hover:shadow-[#107c10]/20 transition-all group flex flex-col touch-manipulation transform hover:scale-[1.02]"
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <FaArrowRight className="text-gray-500 group-hover:text-[#107c10] transition-colors" size={16} />
              </div>
            ...
            <Link
              href="/leaderboard"
              className="bg-gradient-to-br from-[#2d2d2d] to-[#252525] p-5 sm:p-6 md:p-7 rounded-xl border border-gray-700 hover:border-yellow-500/50 hover:shadow-lg hover:shadow-yellow-500/20 transition-all group flex flex-col touch-manipulation transform hover:scale-[1.02] relative overflow-hidden"
            >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <FaArrowRight className="text-gray-500 group-hover:text-yellow-500 transition-colors" size={16} />
              </div>
              <p className="text-gray-400 text-sm mb-4 leading-relaxed">
            ...
            {isAdmin && (
              <Link
                ...
                className="bg-gradient-to-br from-[#2d2d2d] to-[#252525] p-5 sm:p-6 md:p-7 rounded-xl border border-gray-700 hover:border-purple-500/50 hover:shadow-lg hover:shadow-purple-500/20 transition-all group flex flex-col touch-manipulation transform hover:scale-[1.02]"
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-white font-semibold text-lg md:text-xl">Audit Log</h3>
                  </div>
                  <FaArrowRight className="text-gray-500 group-hover:text-purple-500 transition-colors" size={16} />
                </div>
                <p className="text-gray-400 text-sm mb-4 leading-relaxed">
          ...
          {/* Info Box */}
          <div className="bg-gradient-to-br from-blue-900/20 to-blue-800/10 border border-blue-500/30 rounded-xl p-5 sm:p-6 md:p-7 shadow-lg">
