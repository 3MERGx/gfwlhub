...
export default function SubmissionsPage() {
  ...
  useEffect(() => {
    ...
    setCurrentPage(1);
  }, [corrections, debouncedSearchQuery, statusFilter, fieldFilter, sortBy, sortOrder, userIdFilter]);
            ...
            {userIdFilter && (
              <div className="mt-3 p-3 bg-[#107c10]/10 border border-[#107c10]/30 rounded-lg">
                <p className="text-sm text-[rgb(var(--text-primary))]">
                  <span className="font-semibold">Filtered by user:</span> Showing corrections for user ID: {userIdFilter}
                  <Link
