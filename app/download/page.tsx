    ...
    <div className="container mx-auto px-4 py-6 md:py-8">
      <div className="max-w-4xl mx-auto">
        <div className="bg-[#202020] p-5 md:p-8 rounded-lg shadow-xl mb-8">
          ...
          <div className="bg-[#2d2d2d] p-4 md:p-6 rounded-lg mb-6">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <p className="text-gray-300 text-sm md:text-base mb-2">
                    <strong className="text-white">Recommended:</strong> Back up
            ...
            {/* Warning Box */}
            <div className="mt-4 p-4 bg-[#3d3d3d] border-l-4 border-yellow-500 rounded-lg">
      ...
      {showRegistryModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75 transition-opacity duration-300 ease-in-out">
          <div className="relative bg-[#2d2d2d] rounded-lg shadow-xl max-w-2xl w-full mx-4 sm:mx-6 lg:mx-auto transform transition-all duration-300 ease-in-out scale-100">
            {/* Modal Header */}
            <div className="flex items-start justify-between p-6 border-b border-gray-600 rounded-t">
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                <h4 className="text-white font-medium mt-4 mb-3">
                  Backup Instructions
                </h4>
                <div className="space-y-4">
                  {/* Step 1 */}
              ...
              {/* Warning */}
              <div className="bg-yellow-900/20 border border-yellow-500/30 mt-4 rounded-lg p-4">
                <div className="flex items-start">
                  <FaInfoCircle className="text-yellow-500 mr-3 mt-1 flex-shrink-0" />
                  <div>
