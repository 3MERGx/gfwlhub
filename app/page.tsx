    ...
    async function fetchStats() {
      try {
        ...
        if (gamesRes.ok) {
          ...
          // Try to get contributor count from leaderboard API (public)
          ...
          try {
            ...
            // Silently fail - contributor count is optional
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        <div className="bg-[#202020] p-8 rounded-lg shadow-xl border-t-4 border-[#107c10] transform transition-all hover:scale-105 hover:shadow-2xl group">
      ...
      <section className="bg-[#202020] p-8 md:p-12 rounded-lg shadow-xl mb-12">
      ...
      {/* Contribute Section */}
      <section className="bg-gradient-to-r from-[#107c10]/10 to-[#0e6b0e]/10 border border-[#107c10]/30 p-8 md:p-12 rounded-lg shadow-xl mb-12">
      ...
      {/* About Section */}
      <section className="bg-[#202020] p-8 md:p-12 rounded-lg shadow-xl text-white">
